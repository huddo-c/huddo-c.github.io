...
function drawChart() {
  ...
  d3.json("https://raw.githubusercontent.com/huddo-c/milestone-chart/main/data/timeline.json").then(function(data) {
    ...
    let scaleLine = d3.scaleLinear()
      .domain([1262304000000, 1555718400000])
...
//circle text
    group.append('text')
      .style('opacity', 0)
      .text(function(data) { return(data.placeName);})
...
/*       group.append('text')
    ...
    data.map(d => {
      ...
      //Emotional
      details.append('div').append('span').classed('position-title text-position', true).text("Emotional");
      details.append('div')
      .attr('class', 'text-desc')
      .attr('id', 'descriptionId-'+ d.id)
      .text(d.emotional);
      //Cognitive
      details.append('div').append('span').classed('position-title text-position', true).text("Cognitive");
      details.append('div')
      .attr('class', 'text-desc')
      .attr('id', 'descriptionId-'+ d.id)
      .text(d.cognitive);
      //Physical
      details.append('div').append('span').classed('position-title text-position', true).text("Physical");
      details.append('div')
      .attr('class', 'text-desc')
      .attr('id', 'descriptionId-'+ d.id)
      .text(d.physical);
